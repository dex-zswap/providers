 ...
 */
function initializeProvider({ connectionStream, jsonRpcStreamName, logger = console, maxEventListeners = 100, shouldSendMetadata = true, shouldSetOnWindow = true, shouldShimWeb3 = false, providerName = 'dexEthereum' }) {
 ...
 */
function setGlobalProvider(providerInstance, providerName = 'dexEthereum') {
    // (window as Record<string, any>).ethereum = providerInstance;
    // window.dispatchEvent(new Event('ethereum#initialized'));
    window[providerName] = providerInstance;
